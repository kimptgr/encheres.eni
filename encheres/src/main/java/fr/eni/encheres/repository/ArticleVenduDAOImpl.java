...
public class ArticleVenduDAOImpl implements ArticleVenduDAO {
	...
	private final String READ_ALL_ARTICLES = "select no_article, nom_article, description, date_debut_encheres, prix_initial, prix_vente, no_utilisateur, no_categorie  from ARTICLES_VENDUS";
